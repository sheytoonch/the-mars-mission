...
const LeftPanel: React.FC<LeftPanelProps> = ({
  ...
  const handleExport = () => {
    const filteredAstronauts = astronauts.filter(
      (astronaut) =>
        astronaut.name &&
        astronaut.name.toLowerCase().includes(searchQuery.toLowerCase())
    );
  ...
  return (
    <div className="left-panel panel">
      <div className="button-group">
        <button className="normal-button" onClick={handleAddClick}>
          New
        </button>
        <button className="normal-button" onClick={handleExport}>
          Export
        </button>
      </div>
      <input
          ...
          {astronauts
            ...
            .map((astronaut) => (
              <li key={astronaut.id} className="list-element">
                <button
                  className="list-element-left-side"
                ...
                <div
                  className="list-element-right-side"
